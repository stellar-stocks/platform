  ...
  return (
    <Drawer.Root shouldScaleBackground>
      ...
      <Drawer.Portal>
        ...
        <Drawer.Content className="bg-[#0b0e11] flex flex-col rounded-t-[10px] h-[85%] mt-24 fixed bottom-0 left-0 right-0 z-50 border-t border-[#1e2329] outline-none">
          <div className="p-4 bg-[#0b0e11] rounded-t-[10px] flex-1 overflow-y-auto no-scrollbar">
            ...
            <div className="flex flex-col gap-1">
              ...
              {markets.map((m) => (
                <Drawer.Close key={m.symbol} asChild>
                  <button
                    onClick={() =>
                      onSelectSymbol(
                        m.symbol === "ETH" ||
